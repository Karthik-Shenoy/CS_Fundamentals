...
goog.exportSymbol('proto.todoPackage.voidMessage', null, global);
/**
 ...
 * @constructor
 */
proto.todoPackage.voidMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.todoPackage.voidMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.todoPackage.voidMessage.displayName = 'proto.todoPackage.voidMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.todoPackage.voidMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.todoPackage.voidMessage.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.todoPackage.voidMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todoPackage.voidMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.todoPackage.voidMessage}
 */
proto.todoPackage.voidMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.todoPackage.voidMessage;
  return proto.todoPackage.voidMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.todoPackage.voidMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.todoPackage.voidMessage}
 */
proto.todoPackage.voidMessage.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.todoPackage.voidMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.todoPackage.voidMessage.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.todoPackage.voidMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todoPackage.voidMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
